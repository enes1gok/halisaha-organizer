...
description: Extends Halisaha Organizer domain logic — matches, players, RSVP, payments, lineup, self-reports, scoring, leaderboard stats. Use when changing Zustand store behavior, domain types, or seed data.
---
...
- [ ] testID + a11y on new interactives ([`ui-ux-design.mdc`](../../rules/ui-ux-design.mdc))
```

## Related

- New route shell → [add-screen](../add-screen/SKILL.md)
