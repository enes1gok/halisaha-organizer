...
description: Güçlü selector desenleri ve migration-güvenli persistence ile Zustand slice ekler veya böler.
---
...
- Store conventions: [.claude/rules/store-architecture.md](.claude/rules/store-architecture.md)
- Dependency boundaries: [.claude/rules/module-boundaries.md](.claude/rules/module-boundaries.md)
- Domain feature workflow: [.claude/skills/add-domain-feature.md](.claude/skills/add-domain-feature.md)
