---
name: add-formation-logic
description: Halisaha Organizer'da yeni taktik kadro formasyonu ekler veya değiştirir (7/8/11 kişilik takımlar → toplam 14/16/22). lineupFormations.ts, koordinat haritası ve testler dahil.
---

# Add formation logic (Halisaha Organizer)
...
- [ ] Governing rule: [.claude/rules/tactical-board-governance.md](.claude/rules/tactical-board-governance.md)
