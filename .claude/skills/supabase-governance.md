...
description: Güvenli auth/RLS kararları, migration hijyeni ve sorgu performans kontrolleri için Supabase görevleri rehberi.
---
...
- **Both:** `npm run test:rls` (CI runs this sequence in [.github/workflows/supabase-rls.yml](../../.github/workflows/supabase-rls.yml)).
...
- [.claude/rules/supabase-governance.md](.claude/rules/supabase-governance.md)
- [.claude/rules/supabase-postgres-performance.md](.claude/rules/supabase-postgres-performance.md)
